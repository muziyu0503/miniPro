...
(function (global, factory) {
  ...
  function createCtx(target) {
    var self = this;
    var id = self.id;
    var targetId = self.targetId;

    if (id) {
      self.ctx = self.ctx || wx.createCanvasContext(id, target);
      self.targetCtx = self.targetCtx || wx.createCanvasContext(targetId, target);
      self.ctx.beginPath();
      self.ctx.setStrokeStyle('#04b00f');
      self.ctx.setLineWidth(10);
      self.ctx.moveTo(6.5, 124);
      self.ctx.lineTo(6.5, 114);
      self.ctx.lineTo(16.5, 114);
      self.ctx.stroke();
    } else {
  ...
  function methods() {
    ...
    self.pushOrign = function (src) {
      ...
      let _info = getImageInfo({ src: src }).then(function (res) {
    ...
    self.getCropperImage = function (opt, fn) {
      ...
      return task().then(function () {
        ...
        // return canvasToTempFilePath.apply(self.pageTarget, arg)
        })
        .then(function (res) {
  ...
  function cutt() {
    ...
    self.setBoundStyle = function (ref) {
      ...
      var mask = ref.mask; if (mask === void 0) mask = 'rgba(0, 0, 0, 0.9)';
  ...
  WeCropper.prototype.createCtx = createCtx;
